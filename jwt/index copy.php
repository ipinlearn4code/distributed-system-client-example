...
<body>
    ...
    if (isset($_COOKIE['jwt'])) {
        ...
        <br>
        <? echo '<strong>' . $_COOKIE['nama'] . '(' . $_COOKIE['id_pengguna'] . ')' . ' </strong>' ?>
        <?php
    } else {
        ?>
    ...
    <br><br />
    <fieldset>
        <? if (isset($_GET['page']) == 'login' and !isset($_COOKIE['jwt'])) { ?>
            <legend>Login</legend>
        ...
        <? } elseif (isset($_GET['page']) == 'tambah' and isset($_COOKIE['jwt'])) { ?>
        ...
        <? } elseif (isset($_GET['page']) == 'ubah' and isset($_COOKIE['jwt'])) {
